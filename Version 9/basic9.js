...
class Swatch{
    ...
    mMove(e){
        ...
        this.insideShape = this.rectBounds(this.xMouse, this.yMouse, this.x, this.y, this.w, this.h); //check if in the boundary
        if(this.insideShape == true){
            this.stroke = colArray[2][10];
        }
    ...
    rectBounds(xM, yM, x, y, w, h){ //edit the values
...
Swatch.selected = "";
Swatch.selectedColour = "rgba(0,0,0)";